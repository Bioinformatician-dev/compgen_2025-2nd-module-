...
# import data
Xen_R1 <- importXenium("~/Desktop/salma files/workshop/data/BreastCancer/Xenium_R1/outs/", 
...
Xen_R1_ondisk <- saveVoltRon(Xen_R1, 
                             format = "HDF5VoltRon", 
                             output = "~/Desktop/salma files/workshop/data/ondisk/Xen_R1", 
                             replace = TRUE)

# load voltron from disk
Xen_R1_ondisk <- loadVoltRon("~/Desktop/salma files/workshop/data/ondisk/Xen_R1/")
...
annotations <- read.table("~/Desktop/salma files/workshop/data/BreastCancer/Xenium_R1/annotation.txt")[,1]
