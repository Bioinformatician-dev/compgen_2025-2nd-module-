...
Xen_R1 <- loadVoltRon("~/Desktop/salma files/workshop/data/ondisk/Xen_R1/")
...
visium_image <- importImageData("~/Desktop/salma files/workshop/data/BreastCancer/Visium/spatial/tissue_lowres_image.png",
                                sample_name = "spatial",
                                channel_names = "DAPI", tile.size = 100)
Xen_R1_image_disk <- saveVoltRon(visium_image, 
                                 format = "HDF5VoltRon", 
                                 output = "~/Desktop/salma files/workshop/data/ondisk/Xen_R1_image/", 
                                 replace = TRUE)

# load H&E data from disk
Xen_R1_image_disk <- loadVoltRon("~/Desktop/salma files/workshop/data/ondisk/visium_image/")

# automated alignment
xen_reg <- registerSpatialData(object_list = list(Xen_R1_image_disk, Xen_R1))
...
# manual alignment
xen_reg <- registerSpatialData(object_list = list(Xen_R1_image_disk, visium_image))
